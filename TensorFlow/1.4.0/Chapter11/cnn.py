...
#    hidden3 = nn_layer(hidden2, 100, 50, 'hidden3')
    ...
    hidden1 = nn_layer(x, 784, 10, 'hidden1')
    hidden2 = nn_layer(hidden1, 10, 10, 'hidden2')
    hidden3 = nn_layer(hidden2, 10, 10, 'hidden3')
    
    with tf.name_scope('output_scope'):
        y = nn_layer(hidden3, 10, 10, 'output', act=tf.identity)
